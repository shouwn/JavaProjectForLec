...
public class TypeI05 implements Item{
	...
	static{
		try {
			image = ImageIO.read(new File("image/Item/Nurungji.gif"));
		} catch (IOException e) {
			System.err.println("Fail Load Item Type04 Image");
			System.exit(0);
		}
	}
	...
	public Item makeSelf(Point point) {
		return new TypeI05(point.add(-image.getWidth()/2, 0));
	}
