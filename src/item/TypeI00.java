...
public class TypeI00 implements Item{
	...
	static{
		try {
			image = ImageIO.read(new File("image/Item/ItemFork.gif"));
		} catch (IOException e) {
			System.err.println("Fail Load Item Type00 Image");
			System.exit(0);
		}
	}
	...
	public void affectTo(Player player) {
		player.changeBulletTypeTo(Bullets.TYPE_02);
	}
	...
	public Item makeSelf(Point point) {
		return new TypeI00(point.add(-image.getWidth()/2, 0));
	}
