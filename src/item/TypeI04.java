...
public class TypeI04 implements Item{
	...
	static{
		try {
			image = ImageIO.read(new File("image/Item/SteamedEgg.gif"));
		} catch (IOException e) {
			System.err.println("Fail Load Item Type05 Image");
			System.exit(0);
		}
	}
	...
	public Item makeSelf(Point point) {
		return new TypeI04(point.add(-image.getWidth()/2, 0));
	}
