...
public class TypeI03 implements Item{
	...
	static{
		try {
			image = ImageIO.read(new File("image/Item/FishCake.gif"));
		} catch (IOException e) {
			System.err.println("Fail Load Item Type06 Image");
			System.exit(0);
		}
	}
	...
	public Item makeSelf(Point point) {
		return new TypeI03(point.add(-image.getWidth()/2, 0));
	}
