...
public class TypeI06 implements Item{
	...
	static{
		try {
			image = ImageIO.read(new File("image/Item/RiceBall.gif"));
		} catch (IOException e) {
			System.err.println("Fail Load Item Type03 Image");
			System.exit(0);
		}
	}
	...
	public Item makeSelf(Point point) {
		return new TypeI06(point.add(-image.getWidth()/2, 0));
	}
